...
==========================================
Created by Donna-Kay Smith on October 19, 2014
...
The strategy employed was to use the mean for that 5-minute interval to fill each NA value in the steps column.
